          ...
          <div className="container mx-auto px-4 md:px-12 lg:px-20 py-20 space-y-24 relative z-10">
            ...
            >
              ...
              <p className="text-base md:text-lg font-poppins text-gray-600 dark:text-gray-300 leading-relaxed">
                ...
                <span className="italic text-purple-500 dark:text-purple-400">
                  "What if finding a safe place to live was as easy as feeling
                  at home?"
                </span>
                <br />
                <br />
                Frustrated with unverified listings and unsafe living
                conditions, our founders set out to build a platform you can
                trust — where every listing is verified and every stay feels
                like home.
              </p>
            </motion.div>
              ...
              <ul className="list-none space-y-4 text-base md:text-lg font-poppins text-gray-600 dark:text-gray-300">
                ...
                <li className="flex items-start justify-center">
                  ...
                  <span>
                    ...
                    Background checks on property owners and security audits.
                  </span>
                </li>
                <li className="flex items-start justify-center">
                  <span className="text-purple-500 mr-2">•</span>
                ...
                <li className="flex items-start justify-center">
                  <span className="text-purple-500 mr-2">•</span>
                  <span>
                    <span className="font-medium">User-Driven Reviews</span>:
                    Real reviews from real people who stayed before you.
                  </span>
                </li>
                <li className="flex items-start justify-center">
                  <span className="text-purple-500 mr-2">•</span>
            ...
            >
              ...
              <div className="container mx-auto px-4 py-12">
                <div className="flex flex-col md:flex-row justify-center gap-8 max-w-6xl mx-auto">
                  {teamMembers.map((member, index) => (
                    ...
                    >
                      <Card className="max-w-sm mx-auto bg-white border-none dark:bg-gray-800 shadow-lg hover:shadow-2xl transition-shadow duration-300 rounded-xl overflow-hidden">
                        <CardHeader className="flex justify-center bg-gradient-to-b from-purple-100 to-purple-50 dark:from-purple-800 dark:to-purple-700 py-8 relative">
                          <img
                            src={member.image}
                            alt={member.name}
                            className="w-36 h-36 rounded-full mx-auto object-cover border-4 border-purple-200 dark:border-purple-600 shadow-md"
                          />
                        ...
                        <CardFooter className="justify-center pb-6">
                          ...
                          >
                            <div className="grid grid-cols-2 gap-3 ">
                              <Button
                                className="flex items-center gap-2 hover:text-purple-500 text-black font-poppins text-sm rounded-full"
                                aria-label={`Connect with ${member.name} on LinkedIn`}
                              >
                                <Linkedin />
                              </Button>
                              <Button
                                className="flex items-center gap-2 hover:text-purple-600 text-black font-poppins text-sm px-6 py-2 rounded-full"
                                aria-label={`Connect with ${member.name} on LinkedIn`}
                              >
                                <Github size={30} />
                              </Button>
              ...
              <p className="text-base md:text-lg font-poppins text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Our passionate team brings together real estate experts,
                security advisors, tech enthusiasts, and creative minds. Every
                member plays a role in making sure you find a PG you’ll love to
                live in.
              </p>
            </motion.div>
          </div>
